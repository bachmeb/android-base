...
public class BaseActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(0, MENU_OPTION_1, Menu.NONE, getString(R.string.title_activity_second_view));
        menu.add(0, MENU_OPTION_2, Menu.NONE, getString(R.string.title_activity_second_view));
        menu.add(0, MENU_OPTION_3, Menu.NONE, getString(R.string.title_activity_second_view));
        menu.add(0, MENU_OPTION_4, Menu.NONE, getString(R.string.title_activity_second_view));
    ...
    private void openOptionOne() {
        // declare the intent
        Intent intent = new Intent(BaseActivity.this, SecondView.class);
        // act on the intent
